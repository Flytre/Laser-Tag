...
tellraw @s ["",{"text":"/give @s carrot_on_a_stick{ability:\"pistol_2\"}","color":"gold","clickEvent":{"action":"suggest_command","value":"/give @s carrot_on_a_stick{ability:\"pistol_2\"}"}},{"text":": give yourself a(n) pistol_2 ability.","color":"green"}]
tellraw @s ["",{"text":"/give @s carrot_on_a_stick{ability:\"pistol_3\"}","color":"gold","clickEvent":{"action":"suggest_command","value":"/give @s carrot_on_a_stick{ability:\"pistol_3\"}"}},{"text":": give yourself a(n) pistol_3 ability.","color":"green"}]
