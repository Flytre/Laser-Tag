...
give @s[scores={credits=15..},team=green] carrot_on_a_stick{display:{Name:"\"§eWeak Heal\"",Lore:["\"§7Heal §62.5§7 hearts.\"","\"§7The same ability does §cNOT§7 stack.\""]},ability:"weak_heal",CustomModelData:11}
give @s[scores={credits=15..},team=blue] carrot_on_a_stick{display:{Name:"\"§eWeak Heal\"",Lore:["\"§7Heal §62.5§7 hearts.\"","\"§7The same ability does §cNOT§7 stack.\""]},ability:"weak_heal",CustomModelData:11}
