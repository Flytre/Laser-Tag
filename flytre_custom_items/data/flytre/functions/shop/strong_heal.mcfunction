...
give @s[scores={credits=25..},team=green] carrot_on_a_stick{display:{Name:"\"§eStrong Heal\"",Lore:["\"§7Heal §64.0§7 hearts.\"","\"§7The same ability does §cNOT§7 stack.\""]},ability:"strong_heal",CustomModelData:11}
give @s[scores={credits=25..},team=blue] carrot_on_a_stick{display:{Name:"\"§eStrong Heal\"",Lore:["\"§7Heal §64.0§7 hearts.\"","\"§7The same ability does §cNOT§7 stack.\""]},ability:"strong_heal",CustomModelData:11}
