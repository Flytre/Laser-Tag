...
scoreboard players set @a credits 130
...
execute if score map global matches 1 run tellraw @a ["",{"text":"[","color":"green"},{"text":"Game","color":"none"},{"text":"]","color":"green"},{"text":":","color":"none"},{"text":" The map ","color":"none"}, {"text":"Globe","color":"gold"}, {"text":" has been picked.","color":"none"}]
execute if score map global matches 2 run tellraw @a ["",{"text":"[","color":"green"},{"text":"Game","color":"none"},{"text":"]","color":"green"},{"text":":","color":"none"},{"text":" The map ","color":"none"}, {"text":"Laboratory","color":"gold"}, {"text":" has been picked.","color":"none"}]
