...
execute if score game_stage global matches 2 as @s[scores={custom_item=..10}] at @s if block ^ ^ ^1 air if block ^ ^1 ^1 air run function flytre:abilities/blink_effect